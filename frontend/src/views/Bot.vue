...
.title-main { font-weight: 600; font-size: 14px; letter-spacing: -0.01em; }
...
.log-line { padding: 1px 0; color: var(--text-main); display: flex; gap: 10px; word-break: break-word; }
